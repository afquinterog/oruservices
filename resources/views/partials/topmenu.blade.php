  ...
  role="navigation">
    <div class="navbar-header">
      ...
      <a class="navbar-brand navbar-brand-center" href="/">
        ...
        title="Remark">
        <span class="navbar-brand-text hidden-xs-down"> ServerApp</span>
      </a>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              {{-- <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon wb-payment" aria-hidden="true"></i> Facturaci&oacute;n</a>
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon wb-settings" aria-hidden="true"></i> Opciones</a> --}}
